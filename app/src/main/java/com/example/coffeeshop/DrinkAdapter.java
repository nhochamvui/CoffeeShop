...
public class DrinkAdapter extends RecyclerView.Adapter<DrinkAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(@NonNull View itemView, final DrinkAdapter.DrinkOnClickListener onClickListener) {
            super(itemView);
            textViewDrinkName = itemView.findViewById(R.id.textViewSewerName);
            textViewDrinkPrice = itemView.findViewById(R.id.textViewSewerDesc);
            imageViewDrinkImg = itemView.findViewById(R.id.imageViewSewerImg);
