...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener {
        ...
        public ViewHolder(@NonNull View itemView, final OnClickListener onClickListener) {
            ...
            textViewUserName = itemView.findViewById(R.id.textViewDrinkName);
            imageViewAvatar = itemView.findViewById(R.id.imageViewDrinkImg);
            imageViewUpdate = itemView.findViewById(R.id.imageViewSettingDrink);
